import { Text, StyleSheet, View, Button, TouchableOpacity, Image, Dimensions, ScrollView } from 'react-native';
import React, { useState } from 'react';
import { useNavigation } from '@react-navigation/native';
import UserTextInput from 'src/components/UserTextInput';
import { avatars } from 'src/utils/supports';
...
const SignUpScreen = () => {
	...
	const [avatar, setAvatar] = useState<any>(avatars[0]?.image.asset.url);
