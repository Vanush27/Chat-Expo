...
import { SET_USER_NULL } from 'src/context/actions/userActions';
	...
	return (
		<SafeAreaView className="flex-1 items-center justify-start">
			...
			<View className="items-center justify-center">
				...
				<Text className="text-xl font-semibold text-primaryBold pt-7">{user?.fullName}</Text>
			...
			<View className="w-full px-6 py-4 flex-row items-center justify-between">
				<View className="flex-row items-center">
					...
					<Text className="text-base font-semibold text-primaryText px-3">Media's & Downloads</Text>
				</View>
				<MaterialIcons name="chevron-right" size={32} color={'#555'} />
			</View>
