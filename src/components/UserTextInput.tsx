...
interface IUserTextInputProps {
	placeholder: string;
	isPass: boolean;
	setStatValue: any;
	setGetEmailValidationStatus?: any;
}
const UserTextInput = ({ placeholder, isPass, setStatValue, setGetEmailValidationStatus }: IUserTextInputProps) => {
